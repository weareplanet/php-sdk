...
use WeArePlanet\Sdk\Model\AuthenticatedCardRequest;
use WeArePlanet\Sdk\Model\AuthenticatedCardDataCreate;
...
class Constants
{
     ...
     * @var int
     */
    public static int $spaceId = 38055;

    /**
     * @var int
     */
    public static int $userId = 123796;

    /**
     * @var string
     */
    public static string $authenticationKey = 'Px40LRth2QmpyiyDH/G6Zh64oDbsKVJ70AqK2fhokSg=';
     ...
     * @var int
     */
    public static int $testCardPaymentMethodConfigurationId = 374477;
