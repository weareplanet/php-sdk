...
class TransactionVoidSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\TransactionVoid[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\TransactionVoid[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\TransactionVoid[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
