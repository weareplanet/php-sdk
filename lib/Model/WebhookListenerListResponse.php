...
class WebhookListenerListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\WebhookListener[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\WebhookListener[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\WebhookListener[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
