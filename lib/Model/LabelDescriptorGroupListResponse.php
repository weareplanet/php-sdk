...
class LabelDescriptorGroupListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\LabelDescriptorGroup[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\LabelDescriptorGroup[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
