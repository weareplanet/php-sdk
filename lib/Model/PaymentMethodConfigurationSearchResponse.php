...
class PaymentMethodConfigurationSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\PaymentMethodConfiguration[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\PaymentMethodConfiguration[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
