...
class RefundCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets reductions
     *
     * @return \WeArePlanet\Sdk\Model\LineItemReductionCreate[]|null
     */
     ...
     * Sets reductions
     *
     * @param \WeArePlanet\Sdk\Model\LineItemReductionCreate[]|null $reductions The reductions applied on the original transaction items, detailing specific adjustments associated with the refund.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param \WeArePlanet\Sdk\Model\RefundType $type type
     *
     * @return self
     */
