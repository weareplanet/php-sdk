...
class RefundCreate implements ModelInterface, ArrayAccess
{
     ...
     * Sets reductions
     *
     * @param \WeArePlanet\Sdk\Model\LineItemReductionCreate[] $reductions The reductions applied on the original transaction items, detailing specific adjustments associated with the refund.
     *
     * @return $this
     */
