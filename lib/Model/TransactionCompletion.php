...
class TransactionCompletion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\TransactionLineItemVersion|null
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\TransactionLineItemVersion|null $line_item_version line_item_version
     *
     * @return self
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[]|null $base_line_items The original line items from the transaction that serve as the baseline for this completion.
     *
     * @return self
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[]|null $remaining_line_items The line items yet to be captured in the transaction.
     *
     * @return self
     */
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[]|null $line_items The line items captured in this transaction completion.
     *
     * @return self
     */
     ...
     * Gets mode
     *
     * @return \WeArePlanet\Sdk\Model\TransactionCompletionMode|null
     */
     ...
     * Sets mode
     *
     * @param \WeArePlanet\Sdk\Model\TransactionCompletionMode|null $mode mode
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\TransactionCompletionState|null
     */
     ...
     * Sets state
     *
     * @param \WeArePlanet\Sdk\Model\TransactionCompletionState|null $state state
     *
     * @return self
     */
