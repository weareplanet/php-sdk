...
class TransactionCompletion implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[] $base_line_items The original line items from the transaction that serve as the baseline for this completion.
     *
     * @return $this
     */
     ...
     * Sets failure_reason
     *
     * @param \WeArePlanet\Sdk\Model\FailureReason $failure_reason The reason for the failure of the transaction completion.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\TransactionLineItemVersion $line_item_version The specific version of the line items that are being used for this completion.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[] $line_items The line items captured in this transaction completion.
     *
     * @return $this
     */
     ...
     * Sets mode
     *
     * @param \WeArePlanet\Sdk\Model\TransactionCompletionMode $mode The mode of transaction completion, such as online or offline, determining how the completion process is executed.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[] $remaining_line_items The line items yet to be captured in the transaction.
     *
     * @return $this
     */
