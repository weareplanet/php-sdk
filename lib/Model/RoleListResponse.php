...
class RoleListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\Role[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\Role[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\Role[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
