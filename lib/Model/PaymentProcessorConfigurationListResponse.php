...
class PaymentProcessorConfigurationListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\PaymentProcessorConfiguration[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\PaymentProcessorConfiguration[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
