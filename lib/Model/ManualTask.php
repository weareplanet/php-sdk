...
class ManualTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'type' => 'int',
        'actions' => '\WeArePlanet\Sdk\Model\ManualTaskAction[]',
        'created_on' => '\DateTime'
    ];
    ...
    */
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\ManualTaskState|null
     */
     ...
     * Sets state
     *
     * @param \WeArePlanet\Sdk\Model\ManualTaskState|null $state state
     *
     * @return self
     */
     ...
     * Gets actions
     *
     * @return \WeArePlanet\Sdk\Model\ManualTaskAction[]|null
     */
     ...
     * Sets actions
     *
     * @param \WeArePlanet\Sdk\Model\ManualTaskAction[]|null $actions The actions that can be triggered to handle the manual task.
     *
     * @return self
     */
