...
class PaymentAppConnector implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentAppCompletionConfiguration $completion_configuration The completion configuration controlling how deferred completion is processed. If not present, deferred completion is not supported for this connector.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentConnectorConfiguration $connector_configuration The connector configuration created alongside the connector within its designated space. This configuration is used in transactions created using this connector.
     *
     * @return $this
     */
     ...
     * Sets processor
     *
     * @param \WeArePlanet\Sdk\Model\PaymentAppProcessor $processor The payment app processor that the connector belongs to. This relationship is defined when the connector is created.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentAppRefundConfiguration $refund_configuration The refund configuration controlling the behavior for processing refunds. If not present, refunds are not supported for this connector.
     *
     * @return $this
     */
