...
class PaymentConnectorConfigurationListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\PaymentConnectorConfiguration[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\PaymentConnectorConfiguration[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
