...
class ChargeAttempt implements ModelInterface, ArrayAccess
{
     ...
     * Sets charge
     *
     * @param \WeArePlanet\Sdk\Model\Charge $charge The charge that the charge attempt belongs to.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentConnectorConfiguration $connector_configuration The payment connector configuration that was used for the charge attempt.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\CustomersPresence $customers_presence The customer's presence indicates whether and in what way the charge attempt's customer is present.
     *
     * @return $this
     */
     ...
     * Sets environment
     *
     * @param \WeArePlanet\Sdk\Model\ChargeAttemptEnvironment $environment The environment in which the charge attempt is executed.
     *
     * @return $this
     */
     ...
     * Sets failure_reason
     *
     * @param \WeArePlanet\Sdk\Model\FailureReason $failure_reason The reason for the failure of the charge attempt.
     *
     * @return $this
     */
     ...
     * Sets invocation
     *
     * @param \WeArePlanet\Sdk\Model\ConnectorInvocation $invocation The connector invocation that the charge attempt belongs to.
     *
     * @return $this
     */
     ...
     * Sets terminal
     *
     * @param \WeArePlanet\Sdk\Model\PaymentTerminal $terminal The payment terminal through which the charge attempt was made.
     *
     * @return $this
     */
     ...
     * Sets token_version
     *
     * @param \WeArePlanet\Sdk\Model\TokenVersion $token_version The token version used for the charge attempt.
     *
     * @return $this
     */
     ...
     * Sets wallet
     *
     * @param \WeArePlanet\Sdk\Model\WalletType $wallet The type of wallet used to make the charge attempt.
     *
     * @return $this
     */
