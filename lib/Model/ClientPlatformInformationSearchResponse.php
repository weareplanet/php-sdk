...
class ClientPlatformInformationSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\TransactionClientPlatformInformation[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\TransactionClientPlatformInformation[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\TransactionClientPlatformInformation[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
