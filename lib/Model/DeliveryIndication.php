...
class DeliveryIndication implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WeArePlanet\Sdk\Model\DeliveryIndicationDecisionReason $automatic_decision_reason The reason for the automatic system decision about the delivery indication.
     *
     * @return $this
     */
     ...
     * Sets transaction
     *
     * @param \WeArePlanet\Sdk\Model\Transaction $transaction The payment transaction that the delivery indication is linked to.
     *
     * @return $this
     */
