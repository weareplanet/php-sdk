...
class StaticValueSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\StaticValue[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\StaticValue[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\StaticValue[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
