...
class LegalOrganizationFormListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\LegalOrganizationForm[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\LegalOrganizationForm[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
