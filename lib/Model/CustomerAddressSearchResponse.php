...
class CustomerAddressSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\CustomerAddress[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\CustomerAddress[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\CustomerAddress[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
