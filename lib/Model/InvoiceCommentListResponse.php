...
class InvoiceCommentListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\TransactionInvoiceComment[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\TransactionInvoiceComment[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\TransactionInvoiceComment[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
