...
class CustomerEmailAddressListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\RestCustomerEmailAddress[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\RestCustomerEmailAddress[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\RestCustomerEmailAddress[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
