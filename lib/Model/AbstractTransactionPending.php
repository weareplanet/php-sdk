...
class AbstractTransactionPending implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WeArePlanet\Sdk\Model\AddressCreate $billing_address The address associated with the payment method for invoicing and transaction processing purposes.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\AddressCreate $shipping_address The address to where the order will be shipped.
     *
     * @return $this
     */
