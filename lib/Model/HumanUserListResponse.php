...
class HumanUserListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\HumanUser[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\HumanUser[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\HumanUser[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
