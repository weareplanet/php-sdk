...
class Refund implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[] $base_line_items The original base line items from the transaction prior to the refund, serving as a reference for the refunded amounts.
     *
     * @return $this
     */
     ...
     * Sets failure_reason
     *
     * @param \WeArePlanet\Sdk\Model\FailureReason $failure_reason The reason for the failure of the refund.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[] $line_items The line items included in the refund, representing the reductions.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[] $reduced_line_items The line items from the original transaction, adjusted to reflect any reductions applied during the refund process.
     *
     * @return $this
     */
     ...
     * Sets reductions
     *
     * @param \WeArePlanet\Sdk\Model\LineItemReduction[] $reductions The reductions applied on the original transaction items, detailing specific adjustments associated with the refund.
     *
     * @return $this
     */
     ...
     * Sets taxes
     *
     * @param \WeArePlanet\Sdk\Model\Tax[] $taxes The tax breakdown applied to the refund amount, helping with tax calculations or reporting.
     *
     * @return $this
     */
     ...
     * Sets transaction
     *
     * @param \WeArePlanet\Sdk\Model\Transaction $transaction The transaction that the refund belongs to.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param \WeArePlanet\Sdk\Model\RefundType $type The type specifying the method and origin of the refund (e.g., initiated by the customer or merchant).
     *
     * @return $this
     */
