...
class Refund implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets reductions
     *
     * @return \WeArePlanet\Sdk\Model\LineItemReduction[]|null
     */
     ...
     * Sets reductions
     *
     * @param \WeArePlanet\Sdk\Model\LineItemReduction[]|null $reductions The reductions applied on the original transaction items, detailing specific adjustments associated with the refund.
     *
     * @return self
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[]|null $base_line_items The original base line items from the transaction prior to the refund, serving as a reference for the refunded amounts.
     *
     * @return self
     */
     ...
     * Gets taxes
     *
     * @return \WeArePlanet\Sdk\Model\Tax[]|null
     */
     ...
     * Sets taxes
     *
     * @param \WeArePlanet\Sdk\Model\Tax[]|null $taxes The tax breakdown applied to the refund amount, helping with tax calculations or reporting.
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \WeArePlanet\Sdk\Model\RefundType|null
     */
     ...
     * Sets type
     *
     * @param \WeArePlanet\Sdk\Model\RefundType|null $type type
     *
     * @return self
     */
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[]|null $line_items The line items included in the refund, representing the reductions.
     *
     * @return self
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[]|null $reduced_line_items The line items from the original transaction, adjusted to reflect any reductions applied during the refund process.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\RefundState|null
     */
     ...
     * Sets state
     *
     * @param \WeArePlanet\Sdk\Model\RefundState|null $state state
     *
     * @return self
     */
     ...
     * Sets transaction
     *
     * @param \WeArePlanet\Sdk\Model\Transaction|null $transaction transaction
     *
     * @return self
     */
