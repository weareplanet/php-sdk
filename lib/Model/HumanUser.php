...
class HumanUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @return \WeArePlanet\Sdk\Model\TwoFactorAuthenticationType|null
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\TwoFactorAuthenticationType|null $two_factor_type two_factor_type
     *
     * @return self
     */
