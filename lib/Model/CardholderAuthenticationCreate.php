...
class CardholderAuthenticationCreate implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WeArePlanet\Sdk\Model\CardAuthenticationResponse $authentication_response The result of the authentication process.
     *
     * @return $this
     */
     ...
     * Sets version
     *
     * @param \WeArePlanet\Sdk\Model\CardAuthenticationVersion $version The version of the authentication protocol (e.g., 3D Secure 1.0 or 2.0) used for the transaction.
     *
     * @return $this
     */
