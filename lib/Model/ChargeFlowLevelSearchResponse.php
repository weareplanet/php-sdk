...
class ChargeFlowLevelSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\ChargeFlowLevel[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\ChargeFlowLevel[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\ChargeFlowLevel[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
