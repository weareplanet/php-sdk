...
class TransactionVoid implements ModelInterface, ArrayAccess
{
     ...
     * Sets failure_reason
     *
     * @param \WeArePlanet\Sdk\Model\FailureReason $failure_reason The reason for the failure of the transaction void.
     *
     * @return $this
     */
     ...
     * Sets mode
     *
     * @param \WeArePlanet\Sdk\Model\TransactionVoidMode $mode The mode of transaction void, such as online or offline, determining how the void process is executed.
     *
     * @return $this
     */
     ...
     * Sets transaction
     *
     * @param \WeArePlanet\Sdk\Model\Transaction $transaction The transaction that the void belongs to.
     *
     * @return $this
     */
