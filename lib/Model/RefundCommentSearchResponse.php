...
class RefundCommentSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\RefundComment[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\RefundComment[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\RefundComment[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
