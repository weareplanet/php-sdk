...
class AuthenticatedCardDataCreate implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WeArePlanet\Sdk\Model\CardholderAuthenticationCreate $cardholder_authentication Optional authentication details for the cardholder, such as 3D Secure authentication, used when the cardholder has already been verified during the transaction for added security.
     *
     * @return $this
     */
     ...
     * Sets cryptogram
     *
     * @param \WeArePlanet\Sdk\Model\CardCryptogramCreate $cryptogram An additional authentication value that enhances the security of tokenized card transactions.
     *
     * @return $this
     */
     ...
     * Sets pan_type
     *
     * @param \WeArePlanet\Sdk\Model\PanType $pan_type The type of PAN or token, indicating the source or security method of the card information.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\RecurringIndicator $recurring_indicator The indicator used to distinguish between recurring and one-time transactions. If omitted, it will be automatically determined based on the transaction's properties.
     *
     * @return $this
     */
