...
class LineItemCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'attributes' => 'array<string,\WeArePlanet\Sdk\Model\LineItemAttributeCreate>',
    ...
    */
     ...
     * Gets taxes
     *
     * @return \WeArePlanet\Sdk\Model\TaxCreate[]|null
     */
     ...
     * Sets taxes
     *
     * @param \WeArePlanet\Sdk\Model\TaxCreate[]|null $taxes A set of tax lines, each of which specifies a tax applied to the item.
     *
     * @return self
     */
     ...
     * Gets attributes
     *
     * @return array<string,\WeArePlanet\Sdk\Model\LineItemAttributeCreate>|null
     */
     ...
     * Sets attributes
     *
     * @param array<string,\WeArePlanet\Sdk\Model\LineItemAttributeCreate>|null $attributes A map of custom information for the item.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param \WeArePlanet\Sdk\Model\LineItemType $type type
     *
     * @return self
     */
