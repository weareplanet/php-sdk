...
class LineItemCreate implements ModelInterface, ArrayAccess
{
     ...
     * Sets attributes
     *
     * @param map[string,\WeArePlanet\Sdk\Model\LineItemAttributeCreate] $attributes A map of custom information for the item.
     *
     * @return $this
     */
     ...
     * Sets taxes
     *
     * @param \WeArePlanet\Sdk\Model\TaxCreate[] $taxes A set of tax lines, each of which specifies a tax applied to the item.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param \WeArePlanet\Sdk\Model\LineItemType $type The type of the line item.
     *
     * @return $this
     */
