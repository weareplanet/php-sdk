...
class CompletionListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\TransactionCompletion[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\TransactionCompletion[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
