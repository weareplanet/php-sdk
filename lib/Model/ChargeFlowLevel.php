...
class ChargeFlowLevel implements ModelInterface, ArrayAccess
{
     ...
     * Sets configuration
     *
     * @param \WeArePlanet\Sdk\Model\ChargeFlowLevelConfiguration $configuration The configuration that was used for this charge flow level.
     *
     * @return $this
     */
     ...
     * Sets transaction
     *
     * @param \WeArePlanet\Sdk\Model\Transaction $transaction The transaction that the charge flow level belongs to.
     *
     * @return $this
     */
