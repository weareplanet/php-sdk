...
class DocumentTemplateListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\DocumentTemplate[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\DocumentTemplate[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\DocumentTemplate[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
