...
class TransactionCompletionDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets line_items
     *
     * @return \WeArePlanet\Sdk\Model\CompletionLineItemCreate[]|null
     */
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\CompletionLineItemCreate[]|null $line_items The line items to be captured in the transaction completion.
     *
     * @return self
     */
