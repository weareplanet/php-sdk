...
class PaymentAppProcessor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\ChargeAttemptEnvironment|null $configured_environment configured_environment
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\PaymentAppProcessorState|null
     */
     ...
     * Sets state
     *
     * @param \WeArePlanet\Sdk\Model\PaymentAppProcessorState|null $state state
     *
     * @return self
     */
