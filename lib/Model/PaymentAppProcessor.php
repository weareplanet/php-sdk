...
class PaymentAppProcessor implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WeArePlanet\Sdk\Model\ChargeAttemptEnvironment $configured_environment The environment (e.g., test or production) currently configured for the processor.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentProcessorConfiguration $processor_configuration The processor configuration created alongside the process within its designated space. This configuration is used in transactions created using this processor.
     *
     * @return $this
     */
