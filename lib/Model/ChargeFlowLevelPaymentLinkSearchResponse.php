...
class ChargeFlowLevelPaymentLinkSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\ChargeFlowLevelPaymentLink[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\ChargeFlowLevelPaymentLink[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\ChargeFlowLevelPaymentLink[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
