...
class TransactionLineItemVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[]|null $line_items The line items that replace the original line items in the transaction.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\TransactionLineItemVersionState|null
     */
     ...
     * Sets state
     *
     * @param \WeArePlanet\Sdk\Model\TransactionLineItemVersionState|null $state state
     *
     * @return self
     */
