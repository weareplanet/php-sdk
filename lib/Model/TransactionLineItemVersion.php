...
class TransactionLineItemVersion implements ModelInterface, ArrayAccess
{
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[] $line_items The line items that replace the original line items in the transaction.
     *
     * @return $this
     */
     ...
     * Sets transaction
     *
     * @param \WeArePlanet\Sdk\Model\Transaction $transaction The transaction that the line item version belongs to.
     *
     * @return $this
     */
