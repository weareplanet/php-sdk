...
class LineItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'attributes' => 'array<string,\WeArePlanet\Sdk\Model\LineItemAttribute>',
    ...
    */
     ...
     * Sets taxes
     *
     * @param \WeArePlanet\Sdk\Model\Tax[]|null $taxes A set of tax lines, each of which specifies a tax applied to the item.
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \WeArePlanet\Sdk\Model\LineItemType|null
     */
     ...
     * Sets type
     *
     * @param \WeArePlanet\Sdk\Model\LineItemType|null $type type
     *
     * @return self
     */
     ...
     * Gets attributes
     *
     * @return array<string,\WeArePlanet\Sdk\Model\LineItemAttribute>|null
     */
     ...
     * Sets attributes
     *
     * @param array<string,\WeArePlanet\Sdk\Model\LineItemAttribute>|null $attributes A map of custom information for the item.
     *
     * @return self
     */
