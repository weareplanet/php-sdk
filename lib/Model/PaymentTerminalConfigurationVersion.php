...
class PaymentTerminalConfigurationVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets configuration
     *
     * @return \WeArePlanet\Sdk\Model\PaymentTerminalConfiguration|null
     */
     ...
     * Sets configuration
     *
     * @param \WeArePlanet\Sdk\Model\PaymentTerminalConfiguration|null $configuration configuration
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\PaymentTerminalConfigurationVersionState|null
     */
     ...
     * Sets state
     *
     * @param \WeArePlanet\Sdk\Model\PaymentTerminalConfigurationVersionState|null $state state
     *
     * @return self
     */
