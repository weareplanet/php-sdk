...
class AuthenticatedCardData extends TokenizedCardData 
{
     ...
     *
     * @param \WeArePlanet\Sdk\Model\CardholderAuthentication $cardholder_authentication Optional authentication details for the cardholder, such as 3D Secure authentication, used when the cardholder has already been verified during the transaction for added security.
     *
     * @return $this
     */
