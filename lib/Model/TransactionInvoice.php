...
class TransactionInvoice implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WeArePlanet\Sdk\Model\Address $billing_address The address associated with the invoice, used for billing purposes.
     *
     * @return $this
     */
     ...
     * Sets completion
     *
     * @param \WeArePlanet\Sdk\Model\TransactionCompletion $completion The transaction completion this object is linked to.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[] $line_items The invoiced line items that will appear on the invoice document.
     *
     * @return $this
     */
