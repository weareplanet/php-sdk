...
class TransactionInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[]|null $line_items The invoiced line items that will appear on the invoice document.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \WeArePlanet\Sdk\Model\TransactionInvoiceState|null
     */
     ...
     * Sets state
     *
     * @param \WeArePlanet\Sdk\Model\TransactionInvoiceState|null $state state
     *
     * @return self
     */
