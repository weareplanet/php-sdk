...
class PaymentTerminalLocationVersion implements ModelInterface, ArrayAccess
{
     ...
     * Sets address
     *
     * @param \WeArePlanet\Sdk\Model\PaymentTerminalAddress $address The postal address of the location where the payment terminals are used.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentTerminalAddress $contact_address The contact details if the person responsible for the payment terminals at this location.
     *
     * @return $this
     */
     ...
     * Sets location
     *
     * @param \WeArePlanet\Sdk\Model\PaymentTerminalLocation $location The payment terminal location that the version belongs to.
     *
     * @return $this
     */
