...
class SingleSignOnUserListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\SingleSignOnUser[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\SingleSignOnUser[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\SingleSignOnUser[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
