...
class CurrencySearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\RestCurrency[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\RestCurrency[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\RestCurrency[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
