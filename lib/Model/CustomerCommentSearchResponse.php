...
class CustomerCommentSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\CustomerComment[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\CustomerComment[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\CustomerComment[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
