...
class TokenVersion implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WeArePlanet\Sdk\Model\Address $billing_address The billing address to be used for the transaction if no explicit billing address is provided during payment processing.
     *
     * @return $this
     */
     ...
     * Sets environment
     *
     * @param \WeArePlanet\Sdk\Model\ChargeAttemptEnvironment $environment The environment in which the token version was created.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentConnectorConfiguration $payment_connector_configuration The payment connector configuration that initialized the token version.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentInformationHash[] $payment_information_hashes The hashed payment information that the token version represents.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\Address $shipping_address The shipping address to be used for the transaction if no explicit shipping address is provided during payment processing.
     *
     * @return $this
     */
     ...
     * Sets token
     *
     * @param \WeArePlanet\Sdk\Model\Token $token The token that the token version belongs to.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param \WeArePlanet\Sdk\Model\TokenVersionType $type The type specifies the nature of the token and identifies the payment connector capable of processing it.
     *
     * @return $this
     */
