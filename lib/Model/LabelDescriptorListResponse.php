...
class LabelDescriptorListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\LabelDescriptor[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\LabelDescriptor[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\LabelDescriptor[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
