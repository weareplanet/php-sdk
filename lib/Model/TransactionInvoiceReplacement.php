...
class TransactionInvoiceReplacement implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WeArePlanet\Sdk\Model\AddressCreate $billing_address The address associated with the invoice, used for billing purposes.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItemCreate[] $line_items The invoiced line items that will appear on the invoice document.
     *
     * @return $this
     */
