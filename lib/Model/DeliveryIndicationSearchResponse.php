...
class DeliveryIndicationSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\DeliveryIndication[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\DeliveryIndication[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\DeliveryIndication[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
