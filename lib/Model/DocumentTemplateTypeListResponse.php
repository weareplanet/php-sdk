...
class DocumentTemplateTypeListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\DocumentTemplateType[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\DocumentTemplateType[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
