...
class TransactionCommentSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\WeArePlanet\Sdk\Model\TransactionComment[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \WeArePlanet\Sdk\Model\TransactionComment[]|null
     */
     ...
     * Sets data
     *
     * @param \WeArePlanet\Sdk\Model\TransactionComment[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
