...
class TransactionInvoicesService
{
    ...
    public function getPaymentTransactionsInvoicesWithHttpInfo($space, $after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getPaymentTransactionsInvoices'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\InvoiceListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\InvoiceListResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\InvoiceListResponse', []),
            ...
            $returnType = '\WeArePlanet\Sdk\Model\InvoiceListResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WeArePlanet\Sdk\Model\InvoiceListResponse',
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WeArePlanet\Sdk\Model\TransactionInvoice|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WeArePlanet\Sdk\Model\TransactionInvoice|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentTransactionsInvoicesIdWithHttpInfo($id, $space, $expand = null, string $contentType = self::contentTypes['getPaymentTransactionsInvoicesId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\TransactionInvoice' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\TransactionInvoice' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\TransactionInvoice', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WeArePlanet\Sdk\Model\TransactionInvoice';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    public function getPaymentTransactionsInvoicesIdDocumentWithHttpInfo($id, $space, string $contentType = self::contentTypes['getPaymentTransactionsInvoicesIdDocument'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\RenderedDocument' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\RenderedDocument' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\RenderedDocument', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WeArePlanet\Sdk\Model\RenderedDocument';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WeArePlanet\Sdk\Model\InvoiceSearchResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WeArePlanet\Sdk\Model\InvoiceSearchResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentTransactionsInvoicesSearchWithHttpInfo($space, $expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getPaymentTransactionsInvoicesSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\InvoiceSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\InvoiceSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\InvoiceSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WeArePlanet\Sdk\Model\InvoiceSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WeArePlanet\Sdk\Model\InvoiceSearchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int $id id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\TransactionInvoiceReplacement $transaction_invoice_replacement transaction_invoice_replacement (required)
     * @param  string[] $expand expand (optional)
     ...
     * @param  int $id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\TransactionInvoiceReplacement $transaction_invoice_replacement (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postPaymentTransactionsInvoicesIdReplace'] to see the possible values for this operation
     *
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
