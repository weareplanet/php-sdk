...
class TransactionInvoicesService
{
     ...
     * @return \WeArePlanet\Sdk\Model\TransactionInvoice|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse
     */
    public function postPaymentTransactionsInvoicesIdReplace(int $id, int $space, \WeArePlanet\Sdk\Model\TransactionInvoiceReplacement $transaction_invoice_replacement, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsInvoicesIdReplace'][0])
    {
     ...
     * @return array of \WeArePlanet\Sdk\Model\TransactionInvoice|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPaymentTransactionsInvoicesIdReplaceWithHttpInfo(int $id, int $space, \WeArePlanet\Sdk\Model\TransactionInvoiceReplacement $transaction_invoice_replacement, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsInvoicesIdReplace'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentTransactionsInvoicesIdReplaceRequest(int $id, int $space, \WeArePlanet\Sdk\Model\TransactionInvoiceReplacement $transaction_invoice_replacement, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsInvoicesIdReplace'][0])
    {
