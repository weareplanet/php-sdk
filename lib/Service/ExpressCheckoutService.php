...
class ExpressCheckoutService
{
     ...
     *
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\ExpressCheckoutSessionCreate $express_checkout_session_create (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postExpressCheckoutCreateSession'] to see the possible values for this operation
     *
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    public function postExpressCheckoutCreateSessionWithHttpInfo($space, $express_checkout_session_create, string $contentType = self::contentTypes['postExpressCheckoutCreateSession'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\ExpressCheckoutCreateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\ExpressCheckoutCreateResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\ExpressCheckoutCreateResponse', []),
            ...
            $returnType = '\WeArePlanet\Sdk\Model\ExpressCheckoutCreateResponse';
