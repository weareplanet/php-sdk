...
class TransactionLineItemVersionsService
{
    ...
    public function getPaymentTransactionsLineItemVersionsWithHttpInfo($space, $after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getPaymentTransactionsLineItemVersions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\LineItemVersionListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\LineItemVersionListResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\LineItemVersionListResponse', []),
            ...
            $returnType = '\WeArePlanet\Sdk\Model\LineItemVersionListResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WeArePlanet\Sdk\Model\LineItemVersionListResponse',
    ...
    public function getPaymentTransactionsLineItemVersionsIdWithHttpInfo($id, $space, $expand = null, string $contentType = self::contentTypes['getPaymentTransactionsLineItemVersionsId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\TransactionLineItemVersion' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\TransactionLineItemVersion' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\TransactionLineItemVersion', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WeArePlanet\Sdk\Model\TransactionLineItemVersion';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WeArePlanet\Sdk\Model\LineItemVersionSearchResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WeArePlanet\Sdk\Model\LineItemVersionSearchResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentTransactionsLineItemVersionsSearchWithHttpInfo($space, $expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getPaymentTransactionsLineItemVersionsSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\LineItemVersionSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\LineItemVersionSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\LineItemVersionSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WeArePlanet\Sdk\Model\LineItemVersionSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WeArePlanet\Sdk\Model\LineItemVersionSearchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\TransactionLineItemVersionCreate $transaction_line_item_version_create transaction_line_item_version_create (required)
     * @param  string[] $expand expand (optional)
     ...
     *
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\TransactionLineItemVersionCreate $transaction_line_item_version_create (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postPaymentTransactionsLineItemVersions'] to see the possible values for this operation
     *
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
