...
class BoardingSubscriptionStrategyService
{
     ...
     * @param \WeArePlanet\Sdk\Model\BoardingStrategyInformationRequest $boarding_strategy_information_request boarding_strategy_information_request (required)
     ...
     * @return \WeArePlanet\Sdk\Model\BoardingStrategyInformationRequest|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse
     */
    public function postBoardingSubscriptionStrategyInformation(int $account, \WeArePlanet\Sdk\Model\BoardingStrategyInformationRequest $boarding_strategy_information_request, string $contentType = self::contentTypes['postBoardingSubscriptionStrategyInformation'][0])
    {
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WeArePlanet\Sdk\Model\BoardingStrategyInformationRequest|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postBoardingSubscriptionStrategyInformationWithHttpInfo(int $account, \WeArePlanet\Sdk\Model\BoardingStrategyInformationRequest $boarding_strategy_information_request, string $contentType = self::contentTypes['postBoardingSubscriptionStrategyInformation'][0])
    {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\WeArePlanet\Sdk\Model\BoardingStrategyInformationRequest',
                        $request,
                        $response,
                    );
                case 400:
     ...
     */
    public function postBoardingSubscriptionStrategyInformationRequest(int $account, \WeArePlanet\Sdk\Model\BoardingStrategyInformationRequest $boarding_strategy_information_request, string $contentType = self::contentTypes['postBoardingSubscriptionStrategyInformation'][0])
    {
     ...
     *
     * @param int $account Specifies the ID of the account the operation should be executed in. (required)
     * @param \WeArePlanet\Sdk\Model\StoreTrialSubscriptionRequestSetter $store_trial_subscription_request_setter store_trial_subscription_request_setter (required)
     ...
     * @return void
     */
    public function postBoardingSubscriptionStrategyPlans(int $account, \WeArePlanet\Sdk\Model\StoreTrialSubscriptionRequestSetter $store_trial_subscription_request_setter, string $contentType = self::contentTypes['postBoardingSubscriptionStrategyPlans'][0])
    {
     ...
     */
    public function postBoardingSubscriptionStrategyPlansWithHttpInfo(int $account, \WeArePlanet\Sdk\Model\StoreTrialSubscriptionRequestSetter $store_trial_subscription_request_setter, string $contentType = self::contentTypes['postBoardingSubscriptionStrategyPlans'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postBoardingSubscriptionStrategyPlansRequest(int $account, \WeArePlanet\Sdk\Model\StoreTrialSubscriptionRequestSetter $store_trial_subscription_request_setter, string $contentType = self::contentTypes['postBoardingSubscriptionStrategyPlans'][0])
    {
