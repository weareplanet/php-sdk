...
class BogusExpressCheckoutService
{
     ...
     * @param \WeArePlanet\Sdk\Model\BogusExpressCheckoutApprovalRequest $bogus_express_checkout_approval_request bogus_express_checkout_approval_request (required)
     ...
     * @return \WeArePlanet\Sdk\Model\ExpressCheckoutApprovalResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse
     */
    public function postBogusExpressCheckoutOnApprove(string $session_token, int $space, \WeArePlanet\Sdk\Model\BogusExpressCheckoutApprovalRequest $bogus_express_checkout_approval_request, string $contentType = self::contentTypes['postBogusExpressCheckoutOnApprove'][0])
    {
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WeArePlanet\Sdk\Model\ExpressCheckoutApprovalResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postBogusExpressCheckoutOnApproveWithHttpInfo(string $session_token, int $space, \WeArePlanet\Sdk\Model\BogusExpressCheckoutApprovalRequest $bogus_express_checkout_approval_request, string $contentType = self::contentTypes['postBogusExpressCheckoutOnApprove'][0])
    {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\WeArePlanet\Sdk\Model\ExpressCheckoutApprovalResponse',
                        $request,
                        $response,
                    );
                case 400:
     ...
     */
    public function postBogusExpressCheckoutOnApproveRequest(string $session_token, int $space, \WeArePlanet\Sdk\Model\BogusExpressCheckoutApprovalRequest $bogus_express_checkout_approval_request, string $contentType = self::contentTypes['postBogusExpressCheckoutOnApprove'][0])
    {
