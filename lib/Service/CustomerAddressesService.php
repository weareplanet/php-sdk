...
class CustomerAddressesService
{
    ...
    public function getCustomersCustomerIdAddressesWithHttpInfo($customer_id, $space, $after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getCustomersCustomerIdAddresses'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\CustomerAddressListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\CustomerAddressListResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\CustomerAddressListResponse', []),
            ...
            $returnType = '\WeArePlanet\Sdk\Model\CustomerAddressListResponse';
    ...
    public function getCustomersCustomerIdAddressesIdWithHttpInfo($customer_id, $id, $space, $expand = null, string $contentType = self::contentTypes['getCustomersCustomerIdAddressesId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\CustomerAddress' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\CustomerAddress' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\CustomerAddress', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WeArePlanet\Sdk\Model\CustomerAddress';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    public function getCustomersCustomerIdAddressesSearchWithHttpInfo($customer_id, $space, $expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getCustomersCustomerIdAddressesSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\CustomerAddressSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\CustomerAddressSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\CustomerAddressSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WeArePlanet\Sdk\Model\CustomerAddressSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  int $id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\CustomerAddressActive $customer_address_active (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchCustomersCustomerIdAddressesId'] to see the possible values for this operation
     *
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @param  int $customer_id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\CustomerAddressCreate $customer_address_create (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postCustomersCustomerIdAddresses'] to see the possible values for this operation
     *
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
