...
class PaymentWebAppsService
{
     ...
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\PaymentAppChargeAttemptUpdate $payment_app_charge_attempt_update (required)
    ...
    public function patchPaymentWebAppsChargeAttemptsIdWithHttpInfo($id, $space, $payment_app_charge_attempt_update, $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsChargeAttemptsId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\ChargeAttempt' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\ChargeAttempt' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\ChargeAttempt', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\WeArePlanet\Sdk\Model\RestApiErrorResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\RestApiErrorResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\RestApiErrorResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WeArePlanet\Sdk\Model\ChargeAttempt';
     ...
     * @param  int $id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\PaymentAppCompletionUpdate $payment_app_completion_update (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchPaymentWebAppsCompletionsId'] to see the possible values for this operation
     *
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
    ...
    public function patchPaymentWebAppsCompletionsIdWithHttpInfo($id, $space, $payment_app_completion_update, $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsCompletionsId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\TransactionCompletion' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\TransactionCompletion' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\TransactionCompletion', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WeArePlanet\Sdk\Model\TransactionCompletion';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  string $connector_external_id The unique identifier assigned during connector&#39;s creation. (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\PaymentAppConnectorDetails $payment_app_connector_details (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchPaymentWebAppsConnectorsConnectorExternalId'] to see the possible values for this operation
     *
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
    ...
    public function patchPaymentWebAppsConnectorsConnectorExternalIdWithHttpInfo($connector_external_id, $space, $payment_app_connector_details, $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsConnectorsConnectorExternalId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\PaymentAppConnector' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\PaymentAppConnector' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\PaymentAppConnector', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WeArePlanet\Sdk\Model\PaymentAppConnector';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\PaymentAppProcessorDetails $payment_app_processor_details (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchPaymentWebAppsProcessorsExternalId'] to see the possible values for this operation
     *
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
    ...
    public function patchPaymentWebAppsProcessorsExternalIdWithHttpInfo($external_id, $space, $payment_app_processor_details, $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsProcessorsExternalId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\PaymentAppProcessor' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\PaymentAppProcessor' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\PaymentAppProcessor', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WeArePlanet\Sdk\Model\PaymentAppProcessor';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  int $id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\PaymentAppRefundUpdate $payment_app_refund_update (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchPaymentWebAppsRefundsId'] to see the possible values for this operation
     *
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
    ...
    public function patchPaymentWebAppsRefundsIdWithHttpInfo($id, $space, $payment_app_refund_update, $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsRefundsId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\Refund' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\Refund' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\Refund', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WeArePlanet\Sdk\Model\Refund';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  int $id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\PaymentAppVoidUpdate $payment_app_void_update (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchPaymentWebAppsVoidsId'] to see the possible values for this operation
     *
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
    ...
    public function patchPaymentWebAppsVoidsIdWithHttpInfo($id, $space, $payment_app_void_update, $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsVoidsId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WeArePlanet\Sdk\Model\TransactionVoid' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WeArePlanet\Sdk\Model\TransactionVoid' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WeArePlanet\Sdk\Model\TransactionVoid', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WeArePlanet\Sdk\Model\TransactionVoid';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     *
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\PaymentAppProcessorDetailsCreate $payment_app_processor_details_create (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postPaymentWebAppsProcessors'] to see the possible values for this operation
     *
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @param  string $external_id The unique identifier assigned during processor&#39;s creation. (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \WeArePlanet\Sdk\Model\PaymentAppConnectorDetailsCreate $payment_app_connector_details_create (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postPaymentWebAppsProcessorsExternalIdConnectors'] to see the possible values for this operation
     *
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
