...
class PaymentWebAppsService
{
     ...
     * @param int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param \WeArePlanet\Sdk\Model\PaymentAppChargeAttemptUpdate $payment_app_charge_attempt_update payment_app_charge_attempt_update (required)
     ...
     */
    public function patchPaymentWebAppsChargeAttemptsId(int $id, int $space, \WeArePlanet\Sdk\Model\PaymentAppChargeAttemptUpdate $payment_app_charge_attempt_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsChargeAttemptsId'][0])
    {
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WeArePlanet\Sdk\Model\ChargeAttempt|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchPaymentWebAppsChargeAttemptsIdWithHttpInfo(int $id, int $space, \WeArePlanet\Sdk\Model\PaymentAppChargeAttemptUpdate $payment_app_charge_attempt_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsChargeAttemptsId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchPaymentWebAppsChargeAttemptsIdRequest(int $id, int $space, \WeArePlanet\Sdk\Model\PaymentAppChargeAttemptUpdate $payment_app_charge_attempt_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsChargeAttemptsId'][0])
    {
     ...
     * @param int $id id (required)
     * @param int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param \WeArePlanet\Sdk\Model\PaymentAppCompletionUpdate $payment_app_completion_update payment_app_completion_update (required)
     * @param string[]|null $expand expand (optional)
     ...
     */
    public function patchPaymentWebAppsCompletionsId(int $id, int $space, \WeArePlanet\Sdk\Model\PaymentAppCompletionUpdate $payment_app_completion_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsCompletionsId'][0])
    {
     ...
     */
    public function patchPaymentWebAppsCompletionsIdWithHttpInfo(int $id, int $space, \WeArePlanet\Sdk\Model\PaymentAppCompletionUpdate $payment_app_completion_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsCompletionsId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchPaymentWebAppsCompletionsIdRequest(int $id, int $space, \WeArePlanet\Sdk\Model\PaymentAppCompletionUpdate $payment_app_completion_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsCompletionsId'][0])
    {
     ...
     * @param string $connector_external_id The unique identifier assigned during connector&#39;s creation. (required)
     * @param int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param \WeArePlanet\Sdk\Model\PaymentAppConnectorDetails $payment_app_connector_details payment_app_connector_details (required)
     * @param string[]|null $expand expand (optional)
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WeArePlanet\Sdk\Model\PaymentAppConnector|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse
     */
    public function patchPaymentWebAppsConnectorsConnectorExternalId(string $connector_external_id, int $space, \WeArePlanet\Sdk\Model\PaymentAppConnectorDetails $payment_app_connector_details, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsConnectorsConnectorExternalId'][0])
    {
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WeArePlanet\Sdk\Model\PaymentAppConnector|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchPaymentWebAppsConnectorsConnectorExternalIdWithHttpInfo(string $connector_external_id, int $space, \WeArePlanet\Sdk\Model\PaymentAppConnectorDetails $payment_app_connector_details, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsConnectorsConnectorExternalId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchPaymentWebAppsConnectorsConnectorExternalIdRequest(string $connector_external_id, int $space, \WeArePlanet\Sdk\Model\PaymentAppConnectorDetails $payment_app_connector_details, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsConnectorsConnectorExternalId'][0])
    {
     ...
     * @param int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param \WeArePlanet\Sdk\Model\PaymentAppProcessorDetails $payment_app_processor_details payment_app_processor_details (required)
     * @param string[]|null $expand expand (optional)
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WeArePlanet\Sdk\Model\PaymentAppProcessor|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse
     */
    public function patchPaymentWebAppsProcessorsExternalId(string $external_id, int $space, \WeArePlanet\Sdk\Model\PaymentAppProcessorDetails $payment_app_processor_details, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsProcessorsExternalId'][0])
    {
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WeArePlanet\Sdk\Model\PaymentAppProcessor|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchPaymentWebAppsProcessorsExternalIdWithHttpInfo(string $external_id, int $space, \WeArePlanet\Sdk\Model\PaymentAppProcessorDetails $payment_app_processor_details, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsProcessorsExternalId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchPaymentWebAppsProcessorsExternalIdRequest(string $external_id, int $space, \WeArePlanet\Sdk\Model\PaymentAppProcessorDetails $payment_app_processor_details, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsProcessorsExternalId'][0])
    {
     ...
     * @param int $id id (required)
     * @param int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param \WeArePlanet\Sdk\Model\PaymentAppRefundUpdate $payment_app_refund_update payment_app_refund_update (required)
     * @param string[]|null $expand expand (optional)
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WeArePlanet\Sdk\Model\Refund|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse
     */
    public function patchPaymentWebAppsRefundsId(int $id, int $space, \WeArePlanet\Sdk\Model\PaymentAppRefundUpdate $payment_app_refund_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsRefundsId'][0])
    {
     ...
     * @throws \WeArePlanet\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WeArePlanet\Sdk\Model\Refund|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchPaymentWebAppsRefundsIdWithHttpInfo(int $id, int $space, \WeArePlanet\Sdk\Model\PaymentAppRefundUpdate $payment_app_refund_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsRefundsId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchPaymentWebAppsRefundsIdRequest(int $id, int $space, \WeArePlanet\Sdk\Model\PaymentAppRefundUpdate $payment_app_refund_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsRefundsId'][0])
    {
     ...
     * @param int $id id (required)
     * @param int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param \WeArePlanet\Sdk\Model\PaymentAppVoidUpdate $payment_app_void_update payment_app_void_update (required)
     * @param string[]|null $expand expand (optional)
     ...
     */
    public function patchPaymentWebAppsVoidsId(int $id, int $space, \WeArePlanet\Sdk\Model\PaymentAppVoidUpdate $payment_app_void_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsVoidsId'][0])
    {
     ...
     */
    public function patchPaymentWebAppsVoidsIdWithHttpInfo(int $id, int $space, \WeArePlanet\Sdk\Model\PaymentAppVoidUpdate $payment_app_void_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsVoidsId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchPaymentWebAppsVoidsIdRequest(int $id, int $space, \WeArePlanet\Sdk\Model\PaymentAppVoidUpdate $payment_app_void_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentWebAppsVoidsId'][0])
    {
     ...
     *
     * @param int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param \WeArePlanet\Sdk\Model\PaymentAppProcessorDetailsCreate $payment_app_processor_details_create payment_app_processor_details_create (required)
     * @param string[]|null $expand expand (optional)
     ...
     * @return \WeArePlanet\Sdk\Model\PaymentAppProcessor|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse
     */
    public function postPaymentWebAppsProcessors(int $space, \WeArePlanet\Sdk\Model\PaymentAppProcessorDetailsCreate $payment_app_processor_details_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentWebAppsProcessors'][0])
    {
     ...
     * @return array of \WeArePlanet\Sdk\Model\PaymentAppProcessor|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPaymentWebAppsProcessorsWithHttpInfo(int $space, \WeArePlanet\Sdk\Model\PaymentAppProcessorDetailsCreate $payment_app_processor_details_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentWebAppsProcessors'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentWebAppsProcessorsRequest(int $space, \WeArePlanet\Sdk\Model\PaymentAppProcessorDetailsCreate $payment_app_processor_details_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentWebAppsProcessors'][0])
    {
     ...
     * @param string $external_id The unique identifier assigned during processor&#39;s creation. (required)
     * @param int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param \WeArePlanet\Sdk\Model\PaymentAppConnectorDetailsCreate $payment_app_connector_details_create payment_app_connector_details_create (required)
     * @param string[]|null $expand expand (optional)
     ...
     * @return \WeArePlanet\Sdk\Model\PaymentAppConnector|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse|\WeArePlanet\Sdk\Model\RestApiErrorResponse
     */
    public function postPaymentWebAppsProcessorsExternalIdConnectors(string $external_id, int $space, \WeArePlanet\Sdk\Model\PaymentAppConnectorDetailsCreate $payment_app_connector_details_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentWebAppsProcessorsExternalIdConnectors'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentWebAppsProcessorsExternalIdConnectorsRequest(string $external_id, int $space, \WeArePlanet\Sdk\Model\PaymentAppConnectorDetailsCreate $payment_app_connector_details_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentWebAppsProcessorsExternalIdConnectors'][0])
    {
